...
- **Always try the [master branch](https://github.com/carpediem/jsend)** - to see if the reported bug has not already been fixed.
...
We accept contributions via Pull Requests on [Github](https://github.com/carpediem/jsend/pull).
